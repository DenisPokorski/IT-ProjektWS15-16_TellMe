...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "tellme" because\n';
  ...
  $wnd.__gwt_activeModules['tellme'] = {
    'moduleName' : 'tellme',
    'bindings' : function() {
      return {};
    }
 ...
 * "/tellme.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['tellme'].superdevmode = true;

  var expectedSuffix = '/tellme.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + tellme + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:tellme';
  var devModeSessionKey = '__gwtDevModeSession:tellme';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/tellme/tellme.nocache.js';
  ...
  $wnd.__gwt_activeModules['tellme'].canRedirect = true;
  $wnd.__gwt_activeModules['tellme'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/tellme?user.agent=' + ua + '&_callback=' + callback;
