...
/**
 * Die Klasse BusinessObject ist die Superklasse für alle anderen Businnes Objekte. Sie vererbt die ID, Sichtbarkeit und ErstellungsDatum sowie die get-
 * und set-Methoden
 * @author Nicole Reum
 *
 */
...
public class BusinessObject implements Serializable {
	...
	/**
	 * Bei der ID handelt es sich um eine Integer-Variable
	 * Bei der Sichtbarkeit handelt es sich um eine Integer-Variable
	 * Bei erstellungsDatum handelt es sich um die Veriable vom Typ Timestamp
	 */
	...
	/**
	 * Das erstellungsDatum bekommt das erstellungsDatum aus der Datenbank zugewiesen
