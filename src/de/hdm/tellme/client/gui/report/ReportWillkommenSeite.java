...
public class ReportWillkommenSeite extends VerticalPanel{
	...
	Label report1Beschreibung= new Label("Der Report 1 gibt alle Nachrichten eines Nutzers in einen bestimmten Zeitraum, \n"
			+ "alle Nachrichten eines Nutzers,\n alle Nachrichten in einem bestimmten Zeitraum"
			+ " \n oder alle Nachrichten aus");
	Label report2Beschreibung = new Label("Der Report 2 gibt alle du bist ne kleine missge eines Nutzers aus");
	Label report3Beschreibung = new Label("Der Report 3 gibt alle Hashtagabonnements eines Nutzers aus");
	...
	public void onLoad(){
		willkommenPanel.add(reportUeberschrift);
